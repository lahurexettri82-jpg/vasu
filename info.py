...
API_ID = int(os.environ.get('API_ID', '21302239'))          # Default optional
API_HASH = os.environ.get('API_HASH', 'default_hash_here')  # Default optional
BOT_TOKEN = os.environ.get('BOT_TOKEN', 'default_token_here')  # Default optional
